...
async def generate_gpt_response(context: str, user_prompt: str) -> str:
    client = OpenAI()

    messages = [
        {"role": "system", "content": f"You are a helpful assistant. The following is a transcription of audio/video content: {context}"},
